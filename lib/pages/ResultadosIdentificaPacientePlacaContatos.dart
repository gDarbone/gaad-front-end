...
import 'ResultadosIdentificaPacientePlacaPerfil.dart';

class ResultadoIdentificaPacientePlacaContatos extends StatefulWidget {
  Map<String, dynamic> responseUsuarioLogado = {};
  String username = '';
  String password = '';
  String placa = '';
  ResultadoIdentificaPacientePlacaContatos(this.responseUsuarioLogado, this.username, this.password, this.placa,{
    super.key,
  });

  @override
  State<ResultadoIdentificaPacientePlacaContatos> createState() => _ResultadoIdentificaPacientePlacaContatos();
}


class _ResultadoIdentificaPacientePlacaContatos extends State<ResultadoIdentificaPacientePlacaContatos> {
  bool isLoading = true;
  ...
  void navigateToResultadoIdentificaPaciente(){
    final route = MaterialPageRoute(
      builder: (context) => ResultadoIdentificaPacientePlacaPerfil(widget.responseUsuarioLogado, widget.username, widget.password, widget.placa),
    );
